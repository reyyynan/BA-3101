...
$query = "SELECT * FROM recipient_reg";
...
<head>
    ...
    <style>
        ...
        .recipient-list-table th, .recipient-list-table td {
            padding: 10px;
            text-align: left;
        }

        .recipient-list-table th {
...
<h2 style="text-align: center;">Recipient List</h2>

<table class="recipient-list-table" border="1">
    <tr>
        <th>ID</th>
        <th>Name</th>
        <th>Email</th>
    ...
    <tr>
        ...
        <td><?php echo $row['recipient_password']; ?></td>
        <td class="action-links">
            <a href="edit_recipient.php?recipient_id=<?php echo $row['recipient_id']; ?>" class="btn-action">Edit</a>
            <a href="delete_recipient.php?recipient_id=<?php echo $row['recipient_id']; ?>" class="btn-action" onclick="return confirm('Are you sure?');">Delete</a>
        </td>
    </tr>
    <?php endwhile; ?>
</table>
