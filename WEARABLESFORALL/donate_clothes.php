...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Prepare the SQL statement for clothes donation
    $stmt = $conn->prepare("INSERT INTO clothes_donation (donor_id, name, contact_number, email, size_category, `condition`, quantity, pickup_dropoff, schedule_datetime) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
    ...
    $email = $_POST['email'];
    $size_category = $_POST['size']; // Size category from form
...
<div class="form-container_donate-shoes">
    <h2 class="donate-shoes_h2">Donate Clothes</h2>
    <form action="donate_clothes.php" method="POST">
        <!-- Form fields here -->
        ...
        <div class="form-group_donate-shoes">
    <label class="donate-shoes_label" for="size">Clothes Size Category</label>
    <select id="size" name="size" class="donate-shoes_select" required>
        ...
        <div class="form-group_donate-shoes">
    <label class="donate-shoes_label" for="condition">Condition of Clothes</label>
